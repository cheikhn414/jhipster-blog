...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'b0def6ca-c18f-4219-97b0-5039cd220150' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('cb148cc4-19e3-4b71-ae79-6f27732ec0e3');
      cy.get(`[data-cy="name"]`).should('have.value', 'cb148cc4-19e3-4b71-ae79-6f27732ec0e3');
